...
</strong><p style="font-size: 19px; line-height: 20px;">An appointment is scheduled with <strong><?=CLIENT_NAME;?></strong>. on
<span style="font-size: 19px; font-weight:bold; line-height: 18px; color:#222;"><?=$date_pass;?> </span>at 
<span style="font-size: 19px; font-weight:bold; line-height: 18px; color:#222;"><?=$time_pass;?></span><br/></span></p>
<p style="font-size:19px; line-height:18px;">
<?=$message_body;?>
</p>
</div>
</div>
...
<div style="color:#FFFFFF;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:25px;padding-right:10px;padding-bottom:25px;padding-left:10px;">
<div style="font-size: 12px; line-height: 14px; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; color: #FFFFFF;">
<p style="font-size: 14px; line-height: 16px; text-align: center; margin: 0;"><?=CLIENT_COPYRIGHT;?></p>
</div>
</div>
