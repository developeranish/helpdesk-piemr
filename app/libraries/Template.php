...
class Template {
    ...
    function add_meta($key, $val) {
        $success = FALSE;
        $meta = '<meta name="' . $key . '" content="' . $val . '" />'.PHP_EOL;
    ...
    /**
     * Dynamically include social meta tags in the template
     *
     * @param string $key meta name
     * @param string $value meta content
     * @return bool
     */
    function add_social_meta($key, $val) {
        $success = FALSE;
        $meta = '<meta property="' . $key . '" content="' . $val . '" />'.PHP_EOL;
